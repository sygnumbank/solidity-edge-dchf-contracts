...
contract Whitelistable is Initializable, Operatorable {
    ...
    event InitializeWhitelist(address indexed whitelist);
    ...
    function initialize(address _baseOperators, address _whitelist) public initializer {
        ...
        emit InitializeWhitelist(_whitelist);
    }
...
contract TraderOperatorable is Operatorable {
     ...
     */
    function initialize(address _baseOperators, address _whitelist, address _traderOperators) public initializer {
