          ...
          describe("unwhitelisted", () => {
            describe("non functional", () => {
              it("revert operator mint for unwhitelisted", async () => {
                await expectRevert(this.token.mint(notWhitelisted, MINT, { from: operator }), "WhitelistableAccountNotWhitelisted()");
              });
              it("revert system mint for unwhitelisted", async () => {
                await expectRevert(this.token.mint(notWhitelisted, MINT, { from: system }), "WhitelistableAccountNotWhitelisted()");
              });
            });
          });
          describe("whitelisted", () => {
            describe("non functional", () => {
              it("revert self whitelist", async () => {
                await expectRevert(this.token.mint(whitelisted, MINT, { from: whitelisted }), "OperatorableCallerNotOperatorOrSystem()");
              });
              it("revert mint 0", async () => {
                await expectRevert(this.token.mint(whitelisted, 0, { from: operator }), "ERC20MintableZeroMintAmount()");
              });
              it("revert mint empty address", async () => {
                await expectRevert(this.token.mint(ZERO_ADDRESS, MINT, { from: operator }), "WhitelistableAccountNotWhitelisted()"); // Cannot add to whitelist before minting
              });
            ...
            describe("frozen", () => {
              ...
              describe("non-functional", () => {
                it("revert system mint frozen", async () => {
                  await expectRevert(this.token.mint(frozen, MINT, { from: system }), `EdgeTokenSystemCallingUnfrozenAccount("${frozen}")`);
                });
              });
            });
            describe("paused", () => {
              ...
              describe("non-functional", async () => {
                it("revert minting", async () => {
                  await expectRevert(this.token.mint(whitelisted, MINT, { from: operator }), "PausablePaused()");
                });
              });
        ...
        describe("batch", () => {
          ...
          describe("non-functional", () => {
            it("revert address count and value count not equal", async () => {
              await expectRevert(this.token.batchMint(TWO_ADDRESSES, [MINT], { from: operator }), "EdgeTokenUnequalArrayLengths()");
            });
            it("revert mint to over 256 addresses", async () => {
              await expectRevert(this.token.batchMint(THREE_HUNDRED_ADDRESS, THREE_HUNDRED_NUMBERS, { from: operator }), "EdgeTokenBatchLimitExceeded()");
            });
          });
          describe("functional", () => {
            ...
            describe("whitelisted/unwhitelisted", () => {
              describe("non-functional", () => {
                it("revert unwhitelisted", async () => {
                  await expectRevert(this.token.burnFor(notWhitelisted, BURN, { from: operator }), "WhitelistableAccountNotWhitelisted()");
                });
                it("revert from attacker", async () => {
                  await expectRevert(this.token.burnFor(whitelisted, BURN, { from: attacker }), "OperatorableCallerNotOperator()");
                });
                it("revert for empty address", async () => {
                  await expectRevert(this.token.burnFor(ZERO_ADDRESS, BURN, { from: operator }), "WhitelistableAccountNotWhitelisted()");
                });
                ...
                it("revert system burnFor", async () => {
                  await expectRevert(this.token.burnFor(whitelisted, BURN, { from: system }), "OperatorableCallerNotOperator()");
                });
              });
              describe("functional", () => {
                describe("from operator", () => {
            ...
            describe("frozen", () => {
              describe("non-functional", () => {
                it("revert system burnFor frozen", async () => {
                  await expectRevert(this.token.burnFor(frozen, BURN, { from: system }), "OperatorableCallerNotOperator()");
                });
              });
              describe("functional", () => {
                describe("from operator", () => {
            ...
            describe("paused", () => {
              ...
              describe("non-functional", () => {
                describe("revert operator burnFor", () => {
                  beforeEach(async () => {
                    await expectRevert(this.token.burnFor(frozen, BURN, { from: operator }), "PausablePaused()");
                  });
                });
              });
            });
          ...
          describe("batch", () => {
            describe("whitelist", () => {
              ...
              describe("minted", () => {
                ...
                describe("non-functional", () => {
                  it("revert address count and value count not equal", async () => {
                    await expectRevert(this.token.batchBurnFor(TWO_ADDRESSES, [BURN], { from: operator }), "EdgeTokenUnequalArrayLengths()");
                  });
        ...
        describe("burn", () => {
          describe("non-functional", () => {
            ...
            it("revert for notWhitelisted", async () => {
              await expectRevert(this.token.burn(BURN, { from: notWhitelisted }), "WhitelistableAccountNotWhitelisted()");
            });
            it("revert for frozen whitelisted ", async () => {
              await expectRevert(this.token.burn(BURN, { from: frozen }), `EdgeTokenAccountFrozen("${frozen}")`);
            });
            describe("paused", () => {
              beforeEach(async () => {
                await this.token.pause({ from: operator });
              ...
              it("revert when paused", async () => {
                await expectRevert(this.token.burn(BURN, { from: whitelisted }), "PausablePaused()");
              });
            });
            describe("functional", () => {
          ...
          describe("non-batch", async () => {
            describe("non-functional", async () => {
              ...
              it("revert confiscate from non-operator", async () => {
                await expectRevert(this.token.confiscate(whitelisted, whitelisted2, this.confiscate, { from: admin }), "OperatorableCallerNotOperator()");
              });
              ...
              describe("when paused", async () => {
                ...
                it("revert confiscate when paused", async () => {
                  await expectRevert(this.token.confiscate(whitelisted, whitelisted2, this.confiscate, { from: operator }), "PausablePaused()");
                });
              });
            });
            describe("functional", async () => {
          ...
          describe("non-batch", async () => {
            describe("non-functional", async () => {
              it("revert confiscatees and values not equal", async () => {
                await expectRevert(this.token.batchConfiscate(TWO_ADDRESSES, TWO_ADDRESSES, [MINT], { from: operator }), "EdgeTokenUnequalArrayLengths()");
              });
      ...
      context("transfer", () => {
        ...
        describe("unwhitelisted", async () => {
          describe("non-functional", async () => {
            it("revert whitelisted transfer to notWhitelisted", async () => {
              await expectRevert(this.token.transfer(notWhitelisted, TRANSFER, { from: whitelisted }), "WhitelistableAccountNotWhitelisted()");
            });
          });
        });
        describe("whitelisted", async () => {
          describe("non-functional", async () => {
            it("revert transfer to empty address", async () => {
              await expectRevert(this.token.transfer(ZERO_ADDRESS, TRANSFER, { from: whitelisted }), "WhitelistableAccountNotWhitelisted()");
            });
        ...
        describe("frozen", async () => {
          describe("non-functional", () => {
            it("revert whitelist transfer to frozen", async () => {
              await expectRevert(this.token.transfer(frozen, TRANSFER, { from: whitelisted }), "FreezableAccountFrozen()");
            });
            it("revert frozen transfer to whitelisted", async () => {
              await expectRevert(this.token.transfer(whitelisted, TRANSFER, { from: frozen }), "FreezableAccountFrozen()");
            });
            it("revert frozen transfer to frozen", async () => {
              await expectRevert(this.token.transfer(frozen1, TRANSFER, { from: frozen }), "FreezableAccountFrozen()");
            });
          });
        });
        describe("pause", async () => {
          ...
          it("revert all transfers", async () => {
            await expectRevert(this.token.transfer(whitelisted1, TRANSFER, { from: whitelisted }), "PausablePaused()");
          });
        });
      }); // End of transfer
          ...
          describe("non-functional", () => {
            describe("non-whitelisted", async () => {
              it("revert notWhitelisted approval to whitelisted", async () => {
                await expectRevert(this.token.approve(whitelisted, this.approve, { from: notWhitelisted }), "WhitelistableAccountNotWhitelisted()");
              });
              it("revert whitelisted approval to notWhitelisted", async () => {
                await expectRevert(this.token.approve(notWhitelisted, this.approve, { from: whitelisted }), "WhitelistableAccountNotWhitelisted()");
              });
              it("revert whitelisted approval to notWhitelisted", async () => {
                await expectRevert(this.token.approve(notWhitelisted, this.approve, { from: whitelisted }), "WhitelistableAccountNotWhitelisted()");
              });
            ...
            describe("frozen", async () => {
              it("revert whitelisted approve frozen", async () => {
                await expectRevert(this.token.approve(frozen, this.approve, { from: whitelisted }), "FreezableAccountFrozen()");
              });
              it("revert frozen approve whitelisted", async () => {
                await expectRevert(this.token.approve(whitelisted, this.approve, { from: frozen }), "FreezableAccountFrozen()");
              });
              it("revert frozen approve frozen", async () => {
                await expectRevert(this.token.approve(frozen1, this.approve, { from: frozen }), "FreezableAccountFrozen()");
              });
            });
            it("revert empty address spender", async () => {
              await expectRevert(this.token.approve(ZERO_ADDRESS, this.approve, { from: whitelisted }), "WhitelistableAccountNotWhitelisted()");
            });
            describe("paused approval", () => {
              ...
              it("revert approve when paused", async () => {
                await expectRevert(this.token.approve(whitelisted2, this.approve, { from: whitelisted }), "PausablePaused()");
              });
            });
          });
          describe("functional", () => {
            ...
            describe("non-functional", () => {
              describe("non-whitelisted", async () => {
                it("revert notWhitelisted increase allowance to whitelisted", async () => {
                  await expectRevert(this.token.increaseAllowance(whitelisted, this.approve, { from: notWhitelisted }), "WhitelistableAccountNotWhitelisted()");
                });
                it("revert whitelisted increase allowance to notWhitelisted", async () => {
                  await expectRevert(this.token.increaseAllowance(notWhitelisted, this.approve, { from: whitelisted }), "WhitelistableAccountNotWhitelisted()");
                });
              });
              describe("frozen", async () => {
                it("revert whitelist increase frozen", async () => {
                  await expectRevert(this.token.increaseAllowance(frozen, this.approvalModification, { from: whitelisted }), "FreezableAccountFrozen()");
                });
                it("revert frozen increase whitelisted", async () => {
                  await expectRevert(this.token.increaseAllowance(whitelisted, this.approvalModification, { from: frozen }), "FreezableAccountFrozen()");
                });
                it("revert frozen increase frozen", async () => {
                  await expectRevert(this.token.increaseAllowance(frozen1, this.approvalModification, { from: frozen }), "FreezableAccountFrozen()");
                });
              });
              ...
              describe("paused increaseAllowance", () => {
                ...
                it("revert increaseAllowance when paused", async () => {
                  await expectRevert(this.token.increaseAllowance(whitelisted, this.approvalModification, { from: whitelisted1 }), "PausablePaused()");
                });
              });
            });
            describe("functional", () => {
            ...
            describe("non-functional", () => {
              describe("non-whitelisted", async () => {
                it("revert notWhitelisted decrease allowance to whitelisted", async () => {
                  await expectRevert(this.token.decreaseAllowance(whitelisted, this.approve, { from: notWhitelisted }), "WhitelistableAccountNotWhitelisted()");
                });
                it("revert whitelisted decrease allowance to notWhitelisted", async () => {
                  await expectRevert(this.token.decreaseAllowance(notWhitelisted, this.approve, { from: whitelisted }), "WhitelistableAccountNotWhitelisted()");
                });
              });
              describe("frozen", async () => {
                it("revert whitelist decrease frozen", async () => {
                  await expectRevert(this.token.decreaseAllowance(frozen, this.approvalModification, { from: whitelisted }), "FreezableAccountFrozen()");
                });
                it("revert frozen decrease whitelisted", async () => {
                  await expectRevert(this.token.decreaseAllowance(whitelisted, this.approvalModification, { from: frozen }), "FreezableAccountFrozen()");
                });
                it("revert frozen decrease frozen", async () => {
                  await expectRevert(this.token.decreaseAllowance(frozen1, this.approvalModification, { from: frozen }), "FreezableAccountFrozen()");
                });
              });
              it("revert empty address", async () => {
                await expectRevert(
              ...
              describe("paused decreaseAllowance", () => {
                ...
                it("revert decreaseAllowance when paused", async () => {
                  await expectRevert(this.token.decreaseAllowance(whitelisted1, this.approvalModification, { from: whitelisted }), "PausablePaused()");
                });
              });
            });
            describe("functional", () => {
                  ...
                  describe("non-functional", () => {
                    describe("frozen", async () => {
                      it("revert whitelisted transferFrom to frozen", async () => {
                        await expectRevert(this.token.transferFrom(whitelisted1, frozen, this.approve, { from: whitelisted }), "FreezableAccountFrozen()");
                      });
                    ...
                    describe("paused transferFrom", async () => {
                      ...
                      it("revert all when paused", async () => {
                        await expectRevert(this.token.transferFrom(whitelisted1, whitelisted2, this.approve, { from: whitelisted }), "PausablePaused()");
                      });
                    });
                  });
                  describe("functional", () => {
                ...
                describe("burnFrom", () => {
                  describe("non-functional", () => {
                    it("revert nonwhitelisted burnFrom to whitelisted", async () => {
                      await expectRevert(this.token.burnFrom(whitelisted, BURN, { from: notWhitelisted }), "WhitelistableAccountNotWhitelisted()");
                    });
                    it("revert whitelisted burnFrom to frozen", async () => {
                      await expectRevert(this.token.burnFrom(frozen, BURN, { from: whitelisted }), "FreezableAccountFrozen()");
                    });
                    it("revert frozen transferFrom to whitelisted", async () => {
                      await expectRevert(this.token.burnFrom(whitelisted, this.approve, { from: frozen }), "FreezableAccountFrozen()");
                    });
                    ...
                    it("revert empty address ", async () => {
                      await expectRevert(this.token.burnFrom(ZERO_ADDRESS, this.overflow, { from: whitelisted }), "WhitelistableAccountNotWhitelisted()");
                    });
                    describe("paused burnFrom", async () => {
                      ...
                      it("revert all when paused", async () => {
                        await expectRevert(this.token.burnFrom(whitelisted1, BURN, { from: whitelisted }), "PausablePaused()");
                      });
                    });
                  });
                  describe("functional", () => {
