...
// File openzeppelin-solidity/contracts/token/ERC20/IERC20Old.sol@v2.5.0

pragma solidity ^0.5.0;

/**
 * @dev Interface of the ERC20Oldstandard as defined in the EIP. Does not include
 * the optional functions; to access them see {ERC20DetailedOld}.
 */
interface IERC20Old {
    /**
...
// File openzeppelin-solidity/contracts/token/ERC20/ERC20DetailedOld.sol@v2.5.0

pragma solidity ^0.5.0;

/**
 * @dev Optional functions from the ERC20Oldstandard.
 */
contract ERC20DetailedOld is IERC20Old {
     ...
     * {IERC20Old-balanceOf} and {IERC20Old-transfer}.
     */
...
// File openzeppelin-solidity/contracts/GSN/ContextOld.sol@v2.5.0

pragma solidity ^0.5.0;

/*
 * @dev Provides information about the current execution ContextOld, including the
...
// File openzeppelin-solidity/contracts/math/SafeMathOld.sol@v2.5.0
 ...
 * `SafeMathOld` restores this intuition by reverting the transaction when an
 * operation overflows.
 *
...
library SafeMathOld {
    ...
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "SafeMathOld: addition overflow");
    ...
    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "SafeMathOld: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "SafeMathOld: multiplication overflow");
    ...
    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "SafeMathOld: division by zero");
    }
    ...
    function mod(uint256 a, uint256 b) internal pure returns (uint256) {
        return mod(a, b, "SafeMathOld: modulo by zero");
    }
...
// File @sygnum/solidity-base-contracts/contracts/helpers/ERC20/ERC20Overload/ERC20Old.sol@v1.0.2

pragma solidity 0.5.12;

/**
 * @dev Implementation of the {IERC20Old} interface.
 *
 * This implementation is agnostic to the way tokens are created. This means
 * that a supply mechanism has to be added in a derived contract using {_mint}.
 * For a generic mechanism see {ERC20MintableOld}.
 *
 ...
 * and does not conflict with the expectations of ERC20Oldapplications.
 *
 ...
 * allowances. See {IERC20Old-approve}.
 */
contract ERC20Old is ContextOld, IERC20Old {
    using SafeMathOld for uint256;
    ...
    /**
     * @dev See {IERC20Old-transferFrom}.
     *
     ...
     * problems described in {IERC20Old-approve}.
     *
...
// File @sygnum/solidity-base-contracts/contracts/role/interface/IBaseOperatorsOld.sol@v1.0.2

/**
 * @title IBaseOperatorsOld
 * @notice Interface for BaseOperators contract
 */

pragma solidity 0.5.12;

interface IBaseOperatorsOld {
...
// File @sygnum/solidity-base-contracts/contracts/helpers/InitializableOld.sol@v1.0.2

pragma solidity 0.5.12;

/**
 * @title InitializableOld
 *
 * @dev Helper contract to support initializer functions. To use it, replace
 * the constructor with a function that has the `initializer` modifier.
 * WARNING: Unlike constructors, initializer functions must be manually
 * invoked. This applies both to deploying an InitializableOld contract, as well
 * as extending an InitializableOld contract via inheritance.
...
contract InitializableOld {
    ...
    modifier initializer() {
        require(
            ...
            "InitializableOld: Contract instance has already been initialized"
        );
...
// File @sygnum/solidity-base-contracts/contracts/role/base/OperatorableOld.sol@v1.0.2

/**
 * @title OperatorableOld
 * @author Team 3301 <team3301@sygnum.com>
 * @dev OperatorableOld contract stores the BaseOperators contract address, and modifiers for
 *       contracts.
 */

pragma solidity 0.5.12;

contract OperatorableOld is InitializableOld {
    IBaseOperatorsOld internal operatorsInst;
    ...
    modifier onlyOperator() {
        require(isOperator(msg.sender), "OperatorableOld: caller does not have the operator role");
        _;
    }
     ...
     */
    modifier onlyAdmin() {
        require(isAdmin(msg.sender), "OperatorableOld: caller does not have the admin role");
        _;
    }
     ...
     */
    modifier onlySystem() {
        require(isSystem(msg.sender), "OperatorableOld: caller does not have the system role");
        _;
    }
    ...
    modifier onlyMultisig() {
        require(isMultisig(msg.sender), "OperatorableOld: caller does not have multisig role");
        _;
    }
    ...
    modifier onlyAdminOrSystem() {
        require(isAdminOrSystem(msg.sender), "OperatorableOld: caller does not have the admin role nor system");
        _;
    }
    ...
    modifier onlyOperatorOrSystem() {
        require(isOperatorOrSystem(msg.sender), "OperatorableOld: caller does not have the operator role nor system");
        _;
    }
     ...
     */
    modifier onlyRelay() {
        require(isRelay(msg.sender), "OperatorableOld: caller does not have relay role associated");
        _;
    }
    ...
    modifier onlyOperatorOrRelay() {
        require(
            ...
            "OperatorableOld: caller does not have the operator role nor relay"
        );
        _;
    }
    ...
    modifier onlyAdminOrRelay() {
        require(
            ...
            "OperatorableOld: caller does not have the admin role nor relay"
        );
        _;
    }
    ...
    modifier onlyOperatorOrSystemOrRelay() {
        require(
            ...
            "OperatorableOld: caller does not have the operator role nor system nor relay"
        );
        _;
    }
    ...
    function setOperatorsContract(address _baseOperators) public onlyAdmin {
        require(_baseOperators != address(0), "OperatorableOld: address of new operators contract can not be zero");
    ...
    function confirmOperatorsContract() public {
        require(operatorsPending != address(0), "OperatorableOld: address of new operators contract can not be zero");
        require(msg.sender == operatorsPending, "OperatorableOld: should be called from new operators contract");
    ...
    function _setOperatorsContract(address _baseOperators) internal {
        require(_baseOperators != address(0), "OperatorableOld: address of new operators contract cannot be zero");
        operatorsInst = IBaseOperatorsOld(_baseOperators);
        emit OperatorsContractChanged(msg.sender, _baseOperators);
    }
}

// File @sygnum/solidity-base-contracts/contracts/helpers/interface/IWhitelistOld.sol@v1.0.2
 ...
 */
contract IWhitelistOld {
    function isWhitelisted(address _account) external view returns (bool);

    function toggleWhitelist(address _account, bool _toggled) external;
}

// File @sygnum/solidity-base-contracts/contracts/helpers/instance/WhitelistableOld.sol@v1.0.2

/**
 * @title WhitelistableOld
 * @author Team 3301 <team3301@sygnum.com>
 * @dev WhitelistableOld contract stores the Whitelist contract address, and modifiers for
 *       contracts.
 */

pragma solidity 0.5.12;

contract WhitelistableOld is InitializableOld, OperatorableOld {
    IWhitelistOld internal whitelistInst;
    ...
    modifier whenWhitelisted(address _account) {
        require(isWhitelisted(_account), "WhitelistableOld: account is not whitelisted");
        _;
    }
    ...
    function setWhitelistContract(address _whitelist) public onlyAdmin {
        require(_whitelist != address(0), "WhitelistableOld: address of new whitelist contract can not be zero");
    ...
    function confirmWhitelistContract() public {
        require(whitelistPending != address(0), "WhitelistableOld: address of new whitelist contract can not be zero");
        require(msg.sender == whitelistPending, "WhitelistableOld: should be called from new whitelist contract");
    ...
    function _setWhitelistContract(address _whitelist) internal {
        require(_whitelist != address(0), "WhitelistableOld: address of new whitelist contract cannot be zero");
        whitelistInst = IWhitelistOld(_whitelist);
        emit WhitelistContractChanged(msg.sender, _whitelist);
    }
}

// File @sygnum/solidity-base-contracts/contracts/helpers/ERC20/ERC20WhitelistOld.sol@v1.0.2

/**
 * @title ERC20WhitelistOld
 * @author Team 3301 <team3301@sygnum.com>
 * @dev Overloading ERC20Oldfunctions to ensure that addresses attempting to particular
 * actions are whitelisted.
 */

pragma solidity 0.5.12;

contract ERC20WhitelistOld is ERC20Old, WhitelistableOld {
    /**
...
// File @sygnum/solidity-base-contracts/contracts/role/trader/TraderOperatorableOld.sol@v1.0.2

/**
 * @title TraderOperatorableOld
 * @author Team 3301 <team3301@sygnum.com>
 * @dev TraderOperatorableOld contract stores TraderOperators contract address, and modifiers for
 *      contracts.
 */

pragma solidity 0.5.12;

contract TraderOperatorableOld is OperatorableOld {
     ...
     */
    modifier onlyTrader() {
        require(isTrader(msg.sender), "TraderOperatorableOld: caller is not trader");
        _;
    }
    ...
    modifier onlyOperatorOrTraderOrSystem() {
        require(
            ...
            "TraderOperatorableOld: caller is not trader or operator or system"
        );
        _;
    }
    ...
    function setTraderOperatorsContract(address _traderOperators) public onlyAdmin {
        require(
            ...
            "TraderOperatorableOld: address of new traderOperators contract can not be zero"
        );
    ...
    function confirmTraderOperatorsContract() public {
        require(
            ...
            "TraderOperatorableOld: address of pending traderOperators contract can not be zero"
        );
        require(
            msg.sender == traderOperatorsPending,
            "TraderOperatorableOld: should be called from new traderOperators contract"
        );
 ...
 *      mechanism that can be triggered by an authorized account in the TraderOperatorableOld
 *      contract.
 */
pragma solidity 0.5.12;

contract Pausable is TraderOperatorableOld {
...
// File @sygnum/solidity-base-contracts/contracts/helpers/ERC20/ERC20PausableOld.sol@v1.0.2

/**
 * @title ERC20PausableOld
 * @author Team 3301 <team3301@sygnum.com>
 * @dev Overloading ERC20Oldfunctions to ensure that the contract has not been paused.
 */

pragma solidity 0.5.12;

contract ERC20PausableOld is ERC20Old, Pausable {
    /**
...
// File @sygnum/solidity-base-contracts/contracts/helpers/FreezableOld.sol@v1.0.2

/**
 * @title FreezableOld
 * @author Team 3301 <team3301@sygnum.com>
 * @dev FreezableOld contract to freeze functionality for particular addresses.  Freezing/unfreezing is controlled
 *       by operators in OperatorableOld contract which is initialized with the relevant BaseOperators address.
 */

pragma solidity 0.5.12;

contract FreezableOld is OperatorableOld {
    ...
    modifier onlyValidAddress(address _address) {
        require(_address != address(0), "FreezableOld: Empty address");
        _;
    }
    ...
    modifier whenNotFrozen(address _account) {
        require(!frozen[_account], "FreezableOld: account is frozen");
        _;
    }
    ...
    modifier whenFrozen(address _account) {
        require(frozen[_account], "FreezableOld: account is not frozen");
        _;
    }
    ...
    function batchToggleFreeze(address[] memory _addresses, bool _toggled) public {
        require(_addresses.length <= 256, "FreezableOld: batch count is greater than 256");
...
// File @sygnum/solidity-base-contracts/contracts/helpers/ERC20/ERC20FreezableOld.sol@v1.0.2

/**
 * @title ERC20FreezableOld
 * @author Team 3301 <team3301@sygnum.com>
 * @dev Overloading ERC20Oldfunctions to ensure client addresses are not frozen for particular actions.
 */

pragma solidity 0.5.12;

contract ERC20FreezableOld is ERC20Old, FreezableOld {
    /**
...
// File @sygnum/solidity-base-contracts/contracts/helpers/ERC20/ERC20MintableOld.sol@v1.0.2

/**
 * @title ERC20MintableOld
 * @author Team 3301 <team3301@sygnum.com>
...
contract ERC20MintableOld is ERC20Old, OperatorableOld {
    /**
    ...
    function _mint(address account, uint256 amount) internal onlyOperatorOrSystem {
        require(amount > 0, "ERC20MintableOld: amount has to be greater than 0");
        super._mint(account, amount);
    }
}

// File @sygnum/solidity-base-contracts/contracts/helpers/ERC20/ERC20SnapshotOld.sol@v1.0.2

/**
 * @title ERC20SnapshotOld
 * @author Team 3301 <team3301@sygnum.com>
 * @notice Records historical balances.
 */
pragma solidity 0.5.12;

contract ERC20SnapshotOld is ERC20Old {
    using SafeMathOld for uint256;
...
// File @sygnum/solidity-base-contracts/contracts/helpers/ERC20/ERC20BurnableOld.sol@v1.0.2

/**
 * @title ERC20BurnableOld
 * @author Team 3301 <team3301@sygnum.com>
...
contract ERC20BurnableOld is ERC20SnapshotOld, OperatorableOld {
    /**
     * @dev Overload ERC20Old_burnFor, burning funds from a particular users address.
...
// File contracts/edge/EdgeTokenOld.sol

/**
 * @title EdgeTokenOld
 * @author Team 3301 <team3301@sygnum.com>
 * @dev EdgeTokenOld is a ERC20Oldtoken that is upgradable and pausable.
...
contract EdgeTokenOld is
    ERC20Old,
    ERC20DetailedOld("Digital CHF", "DCHF", 2),
    InitializableOld,
    ERC20PausableOld,
    ERC20WhitelistOld,
    ERC20FreezableOld,
    ...
    ERC20BurnableOld
{
    ...
    function burn(uint256 _amount) public {
        require(!isFrozen(msg.sender), "EdgeTokenOld: Account must not be frozen");
    ...
    function mint(address _account, uint256 _amount) public {
        if (isSystem(msg.sender)) {
            require(!isFrozen(_account), "EdgeTokenOld: Account must be frozen if system calling.");
        }
    ...
    function batchBurnFor(address[] memory _recipients, uint256[] memory _values) public {
        require(_recipients.length == _values.length, "EdgeTokenOld: values and recipients are not equal.");
        require(_recipients.length <= BATCH_LIMIT, "EdgeTokenOld: batch count is greater than BATCH_LIMIT.");
    ...
    function batchMint(address[] memory _recipients, uint256[] memory _values) public {
        require(_recipients.length == _values.length, "EdgeTokenOld: values and recipients are not equal.");
        require(_recipients.length <= BATCH_LIMIT, "EdgeTokenOld: greater than BATCH_LIMIT.");
        for (uint256 i = 0; i < _recipients.length; i++) {
    ...
    function batchConfiscate(
        ...
        require(
            ...
            "EdgeTokenOld: values and recipients are not equal"
        );
        require(_confiscatees.length <= BATCH_LIMIT, "EdgeTokenOld: batch count is greater than BATCH_LIMIT");
...
// File contracts/edge/upgrade/v1_EdgeTokenOldConstructorUpgradeOld/EdgeTokenOldConstructorUpgradeOld.sol

/**
 * @title EdgeTokenOldConstructor
 * @author Team 3301 <team3301@sygnum.com>
 * @dev This contract will be used in the first version of upgrading the EdgeTokenOld to mitigate
 *      variables initialized in EdgeTokenOld.sol constructor '_name, _symbol, _decimals' that are
 *      not initialized inside of EdgeTokenOldProxy.sol.  Additionally, as '_name, symbol, _decimals'
...
contract EdgeTokenConstructorUpgradeOld is EdgeTokenOld {
    string private _name;
    string private _symbol;
    uint8 private _decimals;
    ...
    function initializeConstructor() public {
        require(!initializedConstructorUpgrade, "EdgeTokenOldConstructorUpgradeOld: already initialized");
        _name = "Digital CHF";
        _symbol = "DCHF";
        _decimals = 2;
...
// File contracts/edge/upgrade/v2_EdgeTokenOldWhitelistableOldUpgrade/EdgeTokenOldWhitelistableOldUpgrade.sol

/**
 * @title EdgeTokenOldConstructor
 * @author Team 3301 <team3301@sygnum.com>
 * @dev This contract will the used in the second upgrade done to EDGE for WhitelistableOld integration.
...
contract EdgeTokenWhitelistableUpgradeOld is EdgeTokenConstructorUpgradeOld {
    bool public initializedWhitelistableUpgrade;

    function initializeWhitelist(address _whitelist) public {
        require(!initializedWhitelistableUpgrade, "EdgeTokenOldWhitelistableOldUpgrade: already initialized");
        _setWhitelistContract(_whitelist);
        initializedWhitelistableUpgrade = true;
    }
}

// File @sygnum/solidity-base-contracts/contracts/role/interface/IBlockerOperatorsOld.sol@v1.0.2

/**
 * @title IBlockerOperatorsOld
 * @notice Interface for BlockerOperators contract
 */

pragma solidity 0.5.12;

contract IBlockerOperatorsOld {
...
// File @sygnum/solidity-base-contracts/contracts/role/blocker/BlockerOperatorableOld.sol@v1.0.2

/**
 * @title BlockerOperatorableOld
 * @author Team 3301 <team3301@sygnum.com>
 * @dev BlockerOperatorableOld contract stores BlockerOperators contract address, and modifiers for
 *      contracts.
 */

pragma solidity 0.5.12;

contract BlockerOperatorableOld is OperatorableOld {
    IBlockerOperatorsOld internal blockerOperatorsInst;
    ...
    modifier onlyBlocker() {
        require(isBlocker(msg.sender), "BlockerOperatorableOld: caller is not blocker role");
        _;
    }
    ...
    modifier onlyBlockerOrOperator() {
        require(
            ...
            "BlockerOperatorableOld: caller is not blocker or operator role"
        );
        _;
    }
    ...
    function setBlockerOperatorsContract(address _blockerOperators) public onlyAdmin {
        require(
            ...
            "BlockerOperatorableOld: address of new blockerOperators contract can not be zero."
        );
    ...
    function confirmBlockerOperatorsContract() public {
        require(
            ...
            "BlockerOperatorableOld: address of pending blockerOperators contract can not be zero"
        );
        require(
            msg.sender == blockerOperatorsPending,
            "BlockerOperatorableOld: should be called from new blockerOperators contract"
        );
    ...
    function _setBlockerOperatorsContract(address _blockerOperators) internal {
        ...
        blockerOperatorsInst = IBlockerOperatorsOld(_blockerOperators);
        emit BlockerOperatorsContractChanged(msg.sender, _blockerOperators);
    }
}

// File @sygnum/solidity-base-contracts/contracts/helpers/ERC20/ERC20BlockableOld.sol@v1.0.2

/**
 * @title ERC20BlockableOld
 * @author Team 3301 <team3301@sygnum.com>
 * @dev For blocking and unblocking particular user funds.
 */
...
contract ERC20BlockableOld is ERC20Old, BlockerOperatorableOld {
...
// File @sygnum/solidity-base-contracts/contracts/helpers/ERC20/ERC20TradeableOld.sol@v1.0.2

/**
 * @title ERC20TradeableOld
 * @author Team 3301 <team3301@sygnum.com>
...
contract ERC20TradeableOld is ERC20Old, TraderOperatorableOld {
    /**
...
// File contracts/edge/upgrade/v3_EdgeTokenOldBlockUnblockTraderUpgrade/EdgeTokenOldBlockUnblockTraderUpgrade.sol

/**
 * @title EdgeTokenOldBlockUnblockTraderUpgrade
 * @author Team 3301 <team3301@sygnum.com>
 * @dev This contract will the used in the third upgrade done to EDGE for block/unblock/trader integration.
 */
pragma solidity 0.5.12;

contract EdgeTokenBlockUnblockTraderUpgradeOld is
    EdgeTokenWhitelistableUpgradeOld,
    ERC20BlockableOld,
    ERC20TradeableOld
{
    ...
    function initializeBlockerTraderOperators(address _blockerOperators, address _traderOperators) public {
        require(!initializedBlockUnblockTraderUpgrade, "EdgeTokenOldBlockUnblockTraderUpgrade: already initialized");
        _setBlockerOperatorsContract(_blockerOperators);
        _setTraderOperatorsContract(_traderOperators);
...
// File contracts/edge/upgrade/v4_EdgeTokenOldDecimalUpgrade/EdgeTokenOldDecimalUpgrade.sol

/**
 * @title EdgeTokenOldDecimalUpgrade
 * @author Team 3301 <team3301@sygnum.com>
 * @dev This contract will be used in the second version of upgrading the EdgeTokenOld to change the decimals value from 2
 *      to 6. Additionally, as '_decimals' was declared private, the getter function 'decimals()' required to be
 *      overloaded to point to the correct/new/overloaded variables.
 */
pragma solidity 0.5.12;

contract EdgeTokenDecimalUpgradeOld is EdgeTokenBlockUnblockTraderUpgradeOld {
    uint8 private _decimals;
    bool public initializedDecimalUpgrade;

    function initializeDecimalsConstructor() public {
        require(!initializedDecimalUpgrade, "EdgeTokenOldDecimalUpgrade: already initialized");
        _decimals = 6;
...
// File contracts/edge/upgrade/v5_EdgeTokenOldSystemConfiscateUpgrade/EdgeTokenOldSystemConfiscateUpgrade.sol
...
contract EdgeTokenSystemConfiscateUpgradeOld is EdgeTokenDecimalUpgradeOld {
    bool public initializedSystemConfiscate;

    function initializeSystemConfiscateConstructor() public {
        require(!initializedSystemConfiscate, "EdgeTokenOldSystemConfiscateUpgrade: already initialized");
